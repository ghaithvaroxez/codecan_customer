      ...
      [
        ...
        VStack(
          [
            ...
            //product options
            cart.optionsSentence.isNotEmpty ? cart.optionsSentence.text.lg.gray600.medium.make() : UiSpacer.emptySpace(),
            cart.optionsSentence.isNotEmpty ? UiSpacer.verticalSpace(space: 10) : UiSpacer.verticalSpace(space: 5),
            //
            VxStepper(
        ...
        VStack(
          [
            ...
            Icon(
              ...
              size: 16,
            ).centered().p8().onInkTap(
                  this.deleteCartItem,
                ).box.roundedFull.color(Colors.red).make(),

            //cart item price
            UiSpacer.verticalSpace(),
            "$currencySymbol ${(cart.selectedQty * cart.price).numCurrency}".text.semiBold.xl.make(),
          ],
