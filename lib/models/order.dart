...
class Order {
  ...
  factory Order.fromJson(dynamic json) {
    return Order(
      ...
      verificationCode: json["verification_code"] == null ? "" : json["verification_code"],
      ...
      //
      paymentMethodId:
          json["payment_method_id"] == null ? null :  int.parse( json["payment_method_id"].toString()),
      ...
      driverId: json["driver_id"] == null ? null :  int.parse( json["driver_id"].toString()),
